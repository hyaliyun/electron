# Getting started[](https://d3js.org/getting-started#getting-started)

D3 works in any JavaScript environment.

## Try D3 online[](https://d3js.org/getting-started#try-d3-online)
...
## D3 in vanilla HTML[](https://d3js.org/getting-started#d3-in-vanilla-html)
...
## Installing from npm[](https://d3js.org/getting-started#installing-from-npm)
...
Most D3 modules (including [d3-scale](https://d3js.org/d3-scale), [d3-array](https://d3js.org/d3-array), [d3-interpolate](https://d3js.org/d3-interpolate), and [d3-format](https://d3js.org/d3-format)) don’t interact with the DOM, so there is no difference when using them in React. You can use them in JSX for purely declarative visualization, such as the line plot below.
...
[Sandbox ↗︎](https://codesandbox.io/s/d3-react-ssr-5g1bm0?file=/src/LinePlot.jsx)

D3 modules that operate on [selections](https://d3js.org/d3-selection/selecting) (including [d3-selection](https://d3js.org/d3-selection), [d3-transition](https://d3js.org/d3-transition), and [d3-axis](https://d3js.org/d3-axis)) do manipulate the DOM, which competes with React’s virtual DOM. In those cases, you can attach a ref to an element and pass it to D3 in a useEffect hook.
...
[Sandbox ↗︎](https://codesandbox.io/s/d3-react-useeffect-5lp0x6?file=/src/LinePlot.jsx)

For more guidance using D3 in React, see [Amelia Wattenberger’s post](https://2019.wattenberger.com/blog/react-and-d3).

## D3 in Svelte[](https://d3js.org/getting-started#d3-in-svelte)

As [with React](https://d3js.org/getting-started#d3-in-react), you can use Svelte exclusively for rendering if you like, and only use D3 modules that don’t manipulate the DOM. Here is a line plot of an array of numbers that uses [d3-shape](https://d3js.org/d3-shape) and [d3-scale](https://d3js.org/d3-scale-chromatic).
...
[REPL ↗︎](https://svelte.dev/repl/ece91c0d8b204d5ea970dbbc0d6783aa?version=3.59.1)

Svelte’s reactive statements (`$:`) pair nicely with D3 [data joins](https://d3js.org/d3-selection/joining) for efficient updates. Below, we use them to render dynamic axes as the data changes.
...
[REPL ↗︎](https://svelte.dev/repl/ff3bf3c7ca454d53913c0c33af0c1250?version=3.59.1)
